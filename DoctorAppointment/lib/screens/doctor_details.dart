...
class _DoctorDetailState extends State<DoctorDetailPage> {
  ...
  doctor_name("assets/dr.jpg", "Dr.Yehia Ebeid", "Density", "250L.E","Heliopolis: sherton",400),
  SizedBox(height: 10,),
  doctor_name("assets/doctor.jpg", "DR. Alyaa Abd Elhameed", "density", "200L.E","Heliopolis:",400),
  SizedBox(height: 10,),
  ...
  SizedBox(height: 10,),
  doctor_name("assets/accounts.png","Dr. Norhan el berry", "Dentisty", "200L.E"," Masr Elgdeda",450),
  SizedBox(height: 10,),
...
//Neurology
   ...
   SizedBox(height: 10,),
   doctor_name("assets/accounts.png","Dr. Andrew Aghabious", "Orthopedics", "200L.E"," Heliopolis:",450),
   SizedBox(height: 10,),
   ...
   doctor_name("assets/cardiology.PNG","Dr. Mohamed Ramdon","cardiology disease","400L.E"," Heliopolis: nozha street",450),
   SizedBox(height: 10,),
   doctor_name("assets/doc.PNG","Dr. sherif hussein", "cardiology disease", "400L.E"," Heliopolis:El fayoum",450),
   SizedBox(height: 10,),
   doctor_name("assets/accounts.png","Dr. waleed abdelfatah", "cardiology disease", "200L.E","Heliopolis: el sabaq street",450),
   SizedBox(height: 10,),
   doctor_name("assets/accounts.png","Dr. Ayman osama", "cardiology disease", "250L.E"," Heliopolis: Gesr El Suez",450),
